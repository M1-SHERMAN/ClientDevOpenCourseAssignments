...
//////////////////////////////////////////////////////////////////////////
// AUELearnProjectCharacter

AUELearnProjectCharacter::AUELearnProjectCharacter()
{
...
void AUELearnProjectCharacter::NotifyControllerChanged()
{
...
void AUELearnProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUELearnProjectCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUELearnProjectCharacter::Look);
	}
	else
	{
...
void AUELearnProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
